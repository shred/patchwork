...
.error1         moveq   #10,d0                  ;Schlug fehl
	...
	;-- Versionstrings ---------------------;
		VERSTAG
		dc.b    "(C) 1997-2002 Richard Körber <rkoerber@gmx.de>",13,10,0
		PRGNAME
		dc.b    " is FreeWare. All Rights Reserved.",13,10,0
		even
...
msg_copyright   VERS
		dc.b    " (C) 1997-2002 by Richard Körber <rkoerber@gmx.de>\n"
		PRGNAME
		dc.b    " is FreeWare. All Rights Reserved.\n\n"
		dc.b    "** NOTE **  This is an early pre-release. Please excuse if it\n"
		dc.b    "  still contains some bugs and flaws. I just want to check\n"
		dc.b    "  out the feedback before I continue developing this tool.\n"
		dc.b    "  So if you find it useful, please send me a mail.\n\n"
		dc.b    "** THE FUTURE OF "
		BASENAME
		dc.b    " DEPENDS ON YOU! **\n\n"
		PRGNAME
		dc.b    " will start up now. Press <CTRL> <C> to remove it again.\n",0
